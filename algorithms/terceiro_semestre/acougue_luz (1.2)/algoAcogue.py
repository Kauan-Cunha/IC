...
import tarjan_inteligente as tarjan
import copy
...
def acougue(custo_reverso, media_esperada):
    ...
    #adicionados em iterações do algoritmo
    ...
    while True:
        ...
        _, custo_invertido, _ = tarjan.tarjan_subgrafo_lista(
                    custo_invertido, 
                    grafo_critico,
                    lista_nos_auxiliares  # Passa a lista
                )
